...
export default function Becomemember() { return (
    <main className="flex flex-col items-center md:h-screen p-6  ">
        <div className="width-full bg-black ">
  <u><h1 className="mb-4 text-xl w-100% pt-4 font-extrabold leading-none tracking-tight bg-black text-white md:text-5xl lg:text-5xl dark:text-white">&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;Become a member of <span className="text-blue-600 dark:text-blue-500 lg:text-6xl">Saral School</span>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;</h1></u>
  </div>
...
<div className="relative flex items-center justify-between md:justify-normal md:odd:flex-row-reverse group is-active">
    ...
    <div className="w-[calc(100%-4rem)] md:w-[calc(50%-2.5rem)] bg-white p-4 rounded border border-slate-200 shadow">
        <div className="flex items-center justify-between space-x-2 mb-1">
            <h2 className="font-bold text-slate-900">STEP 1</h2>
            {/* <time className="font-caveat font-medium text-indigo-500">08/06/2023</time> */}
        </div>
        <h3 className="text-slate-500">Explore and find the Course from our Catalog .</h3>
    </div>
</div>
...
<div className="relative flex items-center justify-between md:justify-normal md:odd:flex-row-reverse group is-active">
    ...
    <div className="w-[calc(100%-4rem)] md:w-[calc(50%-2.5rem)] bg-white p-4 rounded border border-slate-200 shadow">
        ...
        <div className="text-slate-500">Buy the course that will help you with your career</div>
    </div>
</div>
...
<div className="relative flex items-center justify-between md:justify-normal md:odd:flex-row-reverse group is-active">
    ...
    <div className="w-[calc(100%-4rem)] md:w-[calc(50%-2.5rem)] bg-white p-4 rounded border border-slate-200 shadow">
        ...
        <div className="text-slate-500">Apply for scholarship and get free access to many course. we give upto 100% scholarship </div>
    </div>
</div>
...
<div className="relative flex items-center justify-between md:justify-normal md:odd:flex-row-reverse group is-active">
    ...
    <div className="w-[calc(100%-4rem)] md:w-[calc(50%-2.5rem)] bg-white p-4 rounded border border-slate-200 shadow">
        ...
        <div className="text-slate-500">Join our course and head towards a better future . Became the member of  SaralSchool . </div>
    </div>
</div>
