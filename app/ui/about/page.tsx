...
export default function About() {
  ...
  return (
    <main className="flex flex-col w-full sm:m-2 p-1 sm:flex-row md:h-screen ">
      <div className="flex-1 col-span-6 flex flex-col justify-evenly">
        ...
        <h1 className= "text-midnightblue-500 text-3xl sm:text-5xl font-semibold text-center lg:text-start lh-120 pt-5 lg:pt-0">We believe every student have different learning curve.</h1>
        <div className="flex  items-center pt-3 lg:justify-between justify-center ">
            ...
            <Link
            href="/CounsellingRequest" className="text-blueviolet-500 border border-semiblueviolet-500  text-lg font-medium  py-3 px-5 ml-9 sm:py-5 sm:px-16 transition duration-150 ease-in-out rounded-full bg-sky-200 hover:text-white hover:bg-blue-500" >
  ...
  <h3 className=" mb-4 text-xl font-extrabold leading-none tracking-tight text-gray-900 md:text-5xl lg:text-3xl dark:text-white">Check Out Our <span className="text-blue-600 dark:text-blue-500 text-2xl lg:text-4xl">HERO Courses</span></h3>
